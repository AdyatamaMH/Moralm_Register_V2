...
function UserRole({ onRoleChange }) {
    ...
    const centra = [
        ...
        { value: 'twenty-one', label: '21' },
        { value: 'twenty-two', label: '22' },
        { value: 'twenty-three', label: '23' },
        { value: 'twenty-four', label: '24' },
        { value: 'twenty-five', label: '25' },
        { value: 'twenty-six', label: '26' },
        { value: 'twenty-seven', label: '27' },
        { value: 'twenty-eight', label: '28' },
        { value: 'twenty-nine', label: '29' },
        { value: 'thirty', label: '30' },
        { value: 'thirty-one', label: '31' },
        { value: 'thirty-two', label: '32' },
        { value: 'thirty-three', label: '33' },
        { value: 'thirty-four', label: '34' },
        { value: 'thirty-five', label: '35' },
        { value: 'thirty-six', label: '36' },
    ];
